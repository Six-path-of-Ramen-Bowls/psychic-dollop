...
function preload(){
bgImg = loadImage("assets/background45.jpg")

balloonImg = loadImage("assets/Daco_1533592.png")

obsTop1 = loadImage("assets/narutouzamaki.png")
obsTop1.scale=0.9
obsTop2 = loadImage("assets/shuriken.png")

obsBottom1 = loadImage("assets/darkRassengan.png")
obsBottom2 = loadImage("assets/minato.png")
obsBottom3 = loadImage("assets/shuriken78.png")
...
if (balloon.isTouching(topGround)||balloon.isTouching(bottomGround) || balloon.isTouching(topObstaclesGroup)||balloon.isTouching(bottomObstaclesGroup)) {
  gameState = END;
}
